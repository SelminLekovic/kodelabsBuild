(self.webpackChunkkodelabs_backend=self.webpackChunkkodelabs_backend||[]).push([[2544],{98374:(U,L,o)=>{"use strict";o.d(L,{F:()=>O});var e=o(27279),h=o(2309),P=o(61020),v=o(40464);const O=(T={},R={})=>{const{id:E="",...S}=T,{get:V}=(0,h.kY)(),{locale:a}=(0,P.Z)(),Z=(0,h.Xe)(a,{sensitivity:"base"}),{data:m,error:M,isError:F,isLoading:g,refetch:b}=(0,v.useQuery)(["roles",E,S],async()=>{const{data:Q}=await V(`/admin/roles/${E??""}`,{params:S});return Q},R);return{roles:e.useMemo(()=>{let Q=[];return m&&(Array.isArray(m.data)?Q=m.data:Q=[m.data]),[...Q].sort((oe,ee)=>Z.compare(oe.name,ee.name))},[m,Z]),error:M,isError:F,isLoading:g,refetch:b}}},24233:(U,L,o)=>{"use strict";o.d(L,{V:()=>P});var e=o(2309),h=o(40464);const P=(v={id:null},O={})=>{const{id:T,...R}=v,{get:E}=(0,e.kY)(),{data:S,error:V,isError:a,isLoading:Z,refetch:m}=(0,h.useQuery)(["roles",T,"permissions",R],async()=>{const{data:{data:M}}=await E(`/admin/roles/${T}/permissions`,{params:R});return M},O);return{permissions:S,error:V,isError:a,isLoading:Z,refetch:m}}},25545:(U,L,o)=>{"use strict";o.r(L),o.d(L,{CreatePage:()=>me,default:()=>Ae});var e=o(27279),h=o(73354),P=o(27875),v=o(10701),O=o(48102),T=o(74758),R=o(93415),E=o(32370),S=o(23298),V=o(74577),a=o(12881),Z=o(39708),m=o(2309),M=o(76827),F=o(84260),g=o(71563),b=o(10124),z=o.n(b),Q=o(61020),oe=o(49402),ee=o(51447),C=o(72450),de=o(36364),J=o(30909),te=o(90065),Y=o(24233),ue=o(47853);const Le=ue.Ry().shape({name:ue.Z_().required(m.I0.required),description:ue.Z_().required(m.I0.required)}),ce=C.ZP.div`
...
`,pt=({availableActions:t,isActive:n,isGrey:r,isFormDisabled:s,label:i,onClickToggle:l,pathToData:c})=>{const[d,p]=(0,e.useState)(!1),{formatMessage:u}=(0,Z.Z)(),{modifiedData:f,onChangeParentCheckbox:x,onChangeSimpleCheckbox:$}=Y(),W=()=>{p(H=>!H)},k=()=>{p(!1)},A=C()(f,c.split(".."),{}),y=(0,e.useMemo)(()=>Object.keys(A).reduce((H,q)=>(H[q]=J()(A[q],"conditions"),H),{}),[A]),{hasAllActionsSelected:I,hasSomeActionsSelected:D}=Oe(y),B=(0,e.useMemo)(()=>Ht(t,f,c),[t,f,c]),se=B.some(({hasConditions:H})=>H);return e.createElement(Gt,{isActive:n},e.createElement(ct,{isGrey:r},e.createElement(it,{isCollapsable:!0,isFormDisabled:s,label:i,checkboxName:c,onChange:x,onClick:l,someChecked:D,value:I,isActive:n},e.createElement(ut,{paddingLeft:2},n?e.createElement(Q.Z,null):e.createElement(oe.Z,null))),e.createElement(b.k,{style:{flex:1}},B.map(({actionId:H,hasConditions:q,hasAllActionsSelected:K,hasSomeActionsSelected:fe,isDisplayed:Ie,isParentCheckbox:ie,checkboxName:ve,label:Ue})=>Ie?ie?e.createElement(dt,{key:H,justifyContent:"center",alignItems:"center"},q&&e.createElement(mt,null),e.createElement(z.C,{disabled:s,name:ve,"aria-label":u({id:"Settings.permissions.select-by-permission",defaultMessage:"Select {label} permission"},{label:`${Ue} ${i}`}),onValueChange:$e=>{x({target:{name:ve,value:$e}})},indeterminate:fe,value:K})):e.createElement(dt,{key:H,justifyContent:"center",alignItems:"center"},q&&e.createElement(mt,null),e.createElement(z.C,{disabled:s,indeterminate:q,name:ve,onValueChange:$e=>{$({target:{name:ve,value:$e}})},value:K})):e.createElement(Ge,{key:H}))),d&&e.createElement(Ee,{headerBreadCrumbs:[i,"Settings.permissions.conditions.conditions"],actions:B,isFormDisabled:s,onClosed:k,onToggle:W})),e.createElement(zt,null,e.createElement(me,{onClick:W,hasConditions:se})))};pt.propTypes={availableActions:a().array.isRequired,isActive:a().bool.isRequired,isGrey:a().bool.isRequired,isFormDisabled:a().bool.isRequired,label:a().string.isRequired,onClickToggle:a().func.isRequired,pathToData:a().string.isRequired};const Yt=pt,Xt=g.ZP.span`
...
`,Qe=({childrenForm:t,isFormDisabled:n,recursiveLevel:r,pathToDataFromActionRow:s,propertyActions:i,parentName:l,propertyName:c})=>{const{formatMessage:d}=(0,Z.Z)(),{modifiedData:p,onChangeParentCheckbox:u,onChangeSimpleCheckbox:f}=Y(),[x,$]=(0,e.useState)(null),W=A=>{$(y=>y===A?null:A)},k=(0,e.useMemo)(()=>x?t.find(({value:A})=>A===x):null,[x,t]);return e.createElement(en,null,e.createElement(sn,null),t.map(({label:A,value:y,required:I,children:D},B)=>{const se=B+1<t.length,H=Array.isArray(D),q=x===y;return e.createElement(tn,{key:y,isVisible:se},e.createElement(_t,null,e.createElement(qt,{color:"primary200"}),e.createElement(b.k,{style:{flex:1}},e.createElement(nn,{level:r,isActive:q,isCollapsable:H},e.createElement(at,{alignItems:"center",isCollapsable:H,...H&&{onClick:()=>W(y),"aria-expanded":q,onKeyDown:({key:K})=>(K==="Enter"||K===" ")&&W(y),tabIndex:0,role:"button"},title:A},e.createElement(N.Z,{ellipsis:!0},he()(A)),I&&e.createElement(gt,null),e.createElement(Ve,{$isActive:q}))),e.createElement(b.k,{style:{flex:1}},i.map(({actionId:K,label:fe,isActionRelatedToCurrentProperty:Ie})=>{if(!Ie)return e.createElement(Ge,{key:K});const ie=[...s.split(".."),K,"properties",c,...l.split(".."),y],ve=C()(p,ie,!1);if(!D)return e.createElement(ft,{key:fe,justifyContent:"center",alignItems:"center"},e.createElement(z.C,{disabled:n,name:ie.join(".."),"aria-label":d({id:"Settings.permissions.select-by-permission",defaultMessage:"Select {label} permission"},{label:`${l} ${A} ${fe}`}),onValueChange:De=>{f({target:{name:ie.join(".."),value:De}})},value:ve}));const{hasAllActionsSelected:Ue,hasSomeActionsSelected:$e}=Oe(ve);return e.createElement(ft,{key:fe,justifyContent:"center",alignItems:"center"},e.createElement(z.C,{key:fe,disabled:n,name:ie.join(".."),"aria-label":d({id:"Settings.permissions.select-by-permission",defaultMessage:"Select {label} permission"},{label:`${l} ${A} ${fe}`}),onValueChange:De=>{u({target:{name:ie.join(".."),value:De}})},value:Ue,indeterminate:$e}))})))),k&&q&&e.createElement(m.x,{paddingBottom:2},e.createElement(Qe,{isFormDisabled:n,parentName:`${l}..${y}`,pathToDataFromActionRow:s,propertyActions:i,propertyName:c,recursiveLevel:r+1,childrenForm:k.children})))}))};Qe.propTypes={childrenForm:a().array.isRequired,isFormDisabled:a().bool.isRequired,parentName:a().string.isRequired,pathToDataFromActionRow:a().string.isRequired,propertyActions:a().array.isRequired,propertyName:a().string.isRequired,recursiveLevel:a().number.isRequired};const on=(0,e.memo)(Qe),rn=t=>t.reduce((r,s)=>(s.isActionRelatedToCurrentProperty&&r.push(s.actionId),r),[]),an=(t,n,r,s,i)=>{const c=rn(t).reduce((d,p)=>{const u=[...r.split(".."),p,"properties",s,i],f=C()(n,u,!1);return d[p]=f,d},{});return Oe(c)},yt=(0,g.ZP)(b.k)`
  width: ${ne};
  position: relative;
`,ln=(0,g.ZP)(b.k)`
  height: ${je};
  ...
  `}
  ${({isActive:t,theme:n})=>t&&Ke(n)};
`,Je=({childrenForm:t,label:n,isFormDisabled:r,name:s,required:i,pathToData:l,propertyActions:c,propertyName:d,isOdd:p})=>{const{formatMessage:u}=(0,Z.Z)(),[f,x]=(0,e.useState)(null),{modifiedData:$,onChangeCollectionTypeLeftActionRowCheckbox:W,onChangeParentCheckbox:k,onChangeSimpleCheckbox:A}=Y(),y=f===s,I=(0,e.useMemo)(()=>Array.isArray(t)?t:[],[t]),D=I.length>0,B=(0,e.useCallback)(()=>{D&&x(K=>K===s?null:s)},[D,s]),se=({target:{value:K}})=>{W(l,d,s,K)},{hasAllActionsSelected:H,hasSomeActionsSelected:q}=(0,e.useMemo)(()=>an(c,$,l,d,s),[c,$,l,d,s]);return e.createElement(e.Fragment,null,e.createElement(ln,{alignItems:"center",isCollapsable:D,isActive:y,background:p?"neutral100":"neutral0"},e.createElement(b.k,null,e.createElement(it,{onChange:se,onClick:B,isCollapsable:D,isFormDisabled:r,label:n,someChecked:q,value:H,isActive:y},i&&e.createElement(gt,null),e.createElement(Ve,{$isActive:y})),e.createElement(b.k,null,c.map(({label:K,isActionRelatedToCurrentProperty:fe,actionId:Ie})=>{if(!fe)return e.createElement(Ge,{key:K});const ie=[...l.split(".."),Ie,"properties",d,s];if(!D){const De=C()($,ie,!1);return e.createElement(yt,{key:Ie,justifyContent:"center",alignItems:"center"},e.createElement(z.C,{disabled:r,name:ie.join(".."),"aria-label":u({id:"Settings.permissions.select-by-permission",defaultMessage:"Select {label} permission"},{label:`${s} ${K}`}),onValueChange:ns=>{A({target:{name:ie.join(".."),value:ns}})},value:De}))}const ve=C()($,ie,{}),{hasAllActionsSelected:Ue,hasSomeActionsSelected:$e}=Oe(ve);return e.createElement(yt,{key:K,justifyContent:"center",alignItems:"center"},e.createElement(z.C,{disabled:r,name:ie.join(".."),onValueChange:De=>{k({target:{name:ie.join(".."),value:De}})},"aria-label":u({id:"Settings.permissions.select-by-permission",defaultMessage:"Select {label} permission"},{label:`${s} ${K}`}),value:Ue,indeterminate:$e}))})))),y&&e.createElement(on,{childrenForm:I,isFormDisabled:r,parentName:s,pathToDataFromActionRow:l,propertyName:d,propertyActions:c,recursiveLevel:0}))};Je.defaultProps={childrenForm:[],required:!1},Je.propTypes={childrenForm:a().array,label:a().string.isRequired,isFormDisabled:a().bool.isRequired,name:a().string.isRequired,pathToData:a().string.isRequired,propertyActions:a().array.isRequired,propertyName:a().string.isRequired,required:a().bool,isOdd:a().bool.isRequired};const cn=(0,e.memo)(Je),ht=(0,g.ZP)(b.k)`
  width: ${ne};
  flex-shrink: 0;
`,dn=(0,g.ZP)(b.k)`
  width: ${Me};
